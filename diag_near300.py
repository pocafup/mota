"""tokens[280..305] 상세 추적 — 체크포인트 300 직전 모든 이벤트."""
import json, sys
...
print(f"token[279] end: floor={state.current_floor} pos=({state.hero.x},{state.hero.y}) "
...
print(f"Truth: floor=MT5 hp=604 atk=21 def=10")
