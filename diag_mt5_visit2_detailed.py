"""逐格追踪 token[200..310]，打印每步位置和任何阻挡/事件。"""
import json, sys
...
print()
print(f"{'idx':>4}  {'tok':<12}  {'fl':<4}  {'pos':<10}  {'hp':>6}  {'atk':>3}  {'yk':>2}  note")
print('-'*85)

for idx in range(200, 315):
    tok = tokens[idx]
    ...
    # 打印所有步骤（不过滤）
    print(f"{idx:>4}  {tok:<12}  {fl_after:<4}  ({pos_after[0]:>2},{pos_after[1]:>2})  "
          f"{hp_after:>6}  {atk_after:>3}  {yk_after:>2}  {note}")
