...
| J15 | **MT48 地震卷轴破 MT37 墙**（玩家预告）：MT48 商人(5,2 price4000 give earthquake，§shops.json)买地震卷轴 → 使用时破坏 MT37 的墙（跨层 setBlock?）。earthquake 道具的使用效果（炸哪些墙/坐标/是否跨层）待源码坐实，当前 ITEM:earthquake 为 no-op | 中 |
